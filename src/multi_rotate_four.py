...
def main():
    ...
    references = [
        ReferenceObject("./img/ref1.jpg", "./models/fox.obj", 1, sift),
        ReferenceObject("./img/ref2.jpg", "./models/chair.obj", 1, sift),
        ReferenceObject("./img/ref3.jpg", "./models/Man.obj", 1, sift),
        ReferenceObject("./img/ref4.jpg", "./models/Woman.obj", 1, sift)
    ]
